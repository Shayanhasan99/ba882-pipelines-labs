...
# setup the project
gcloud config set project ba-882-pipelines-project
...
gcloud functions deploy dev-schema-setup \
    ...
    --stage-bucket 882-lab3-test-bucket \
    --service-account shayan-lab3@ba-882-pipelines-project.iam.gserviceaccount.com \
    --region us-central1 \
